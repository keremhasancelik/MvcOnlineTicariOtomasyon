...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.d6 = deger6;
            var deger7 = c.Uruns.Count(x => x.Stok<=4).ToString();
            ViewBag.d7 = deger7;
        ...
        public ActionResult KolayTablolar(int sayfa=1)
        {
            ...
            return View(sorgu.ToList().ToPagedList(sayfa,5));
        }
        ...
        public PartialViewResult Partial4()
        {
            var sorgu3 = from x in c.Uruns
                         join u in c.Kategoris on x.Kategoriid equals u.KategoriID
                         select new { x.Kategoriid, u.KategoriAd } into y
                         group y by new { y.Kategoriid, y.KategoriAd } into g
                         select new SinifGrup3
                         {
                             Kategori = g.Key.KategoriAd,
                             Sayi = g.Count()
        ...
        public PartialViewResult Partial5(int sayfa=1)
        {
            ...
            return PartialView(sorgu2.ToList().ToPagedList(sayfa,5));
        }
    }
}